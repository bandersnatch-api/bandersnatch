...
<div className="block mx-auto px-6 	max-width: 768px bg-red-800">
    ...
    rounded-lg shadow-md">
        <h1 className="text-2xl text-center font-bold">You cannot leave the Labyrinth!</h1> <br></br>
        <h2>
          <div className="row">
            <div className="col-md-4 col-xs-6">
              <img src="minotaur_image.jpeg" className="mx-auto d-blockmx-auto d-block img-responsive" />
              <br></br>
            </div>
            </div>
          {questions[5].story}
